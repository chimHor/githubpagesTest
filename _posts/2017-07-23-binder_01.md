...
![]({{ site.url | prepend: site.baseurl}}/pic/binder/AbstractBinderCommunication.png)
...
![]({{ site.url | prepend: site.baseurl}}/pic/binder/ServiceTestA_class.png)
...
![]({{ site.url | prepend: site.baseurl}}/pic/binder/ServiceTestA_seq.png)
